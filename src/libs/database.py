...
import _packages.mysql.connector
from _packages.mysql.connector import pooling, Error
from _packages.DBUtils.PooledDB import PooledDB
...
class Database(object):
    ...
    def getConnection(self):
        ...
        if not Database.pool:
            Database.pool = PooledDB(_packages.mysql.connector, cfg.POOL_SIZE, host=cfg.HOST, port=cfg.PORT,
