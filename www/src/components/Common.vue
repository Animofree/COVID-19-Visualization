...
<div>
    <div class="hello">
        ...
        <!-- 总体数据汇总情况 -->
        <el-card class="box-card" style="background: #fff7c6; ">
            <el-row :gutter="20">
                <el-col :span="6" v-for="item in sums" :key="item.name">
                    <div class="grid-content ">
                        <div class="sum_numb" :style="{color: item.color, fontSize: '25px', marginBottom: '8px'}">{{item.sum}}</div>
                        <div class="sum_numb" style="color: #000000; font-size: 16px">{{item.text}}病例</div>
                        <div class="sum_numb" style="font-size: 16px; color: #6d6d6d; margin-top: 8px">
